...
public class DialogXoaTruyen2 extends Dialog {
private Context context;
private ImageButton btnOK,btnCANCEL;
private TextView ttitle;
private static long idtruyen;
private XoaTruyenThanhCongListener listener;
    public DialogXoaTruyen2(@NonNull Context context, long idTruyen, Context context2, XoaTruyenThanhCongListener listener) {
        super(context);
